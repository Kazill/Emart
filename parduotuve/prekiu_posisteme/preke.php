        ...
        <tr>
            <td>
                ...
                <div style="background-color: aqua; padding: 10px;">
                    ...
                    <?php
                        $sql = "INSERT INTO uzsakymai (data, uzsakymo_kaina, busena, pristatymo_budas, fk_Pirkejasid_Pirkejas, fk_Administratoriusid_Administratorius) 
                        VALUES (now(), $orderData[kaina], 'Progrese', 'Kurjeris', $Id, 5) ";
                            ...
                            $_SESSION['data_inserted']=false;
                              echo "<div style='background-color: aqua; padding: 10px;'>";
                                  echo "<form method='post'>
                                            <input type='submit' value='Įdėti į krepšelį' onclick='window.location.href='/Emart/parduotuve/krepselis.php'>
                                        </form>";
                                  echo "</pre>";
                              echo "</div>";
