...
<html>
    <head>
        ...
        <title>Sudaryti perkamiausių prekių ataskaitą</title>
...
?>
                <div style="text-align: center;color:green">
                    <br><br>
                    <h1>Sudaryti perkamiausių prekių ataskaitą.</h1>
                </div><br>
				<form method='post' action='perkamiausiosprekesa.php'>
				Prekių kiekis:<input name='prekiukiekis' type='number'><br><br>
				Data nuo:<input name='datanuo' type='date'><br><br>
				Data iki:<input name='dataiki' type='date'><br><br>
				<input type='submit' name='JJJJ' value='Sudaryti'>
				</form>
      <?php
          }
          else {   			 
